  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        ...
        sideOffset={10}
        collisionPadding={16}
        className="dark w-auto min-w-[min(100vw-1.5rem,17.5rem)] max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-[3px] border border-white/10 bg-[#000000]/98 p-0 text-foreground shadow-[0_12px_48px_-8px_rgba(0,0,0,0.45)] ring-1 ring-white/6 backdrop-blur-xl rounded-[8px]"
      >
