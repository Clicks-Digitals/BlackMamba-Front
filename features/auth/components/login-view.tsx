...
export function LoginView() {
  ...
  return (
    <div className="dark w-full rounded-lg border border-white/8 bg-[#000000] p-8 shadow-[0_12px_32px_-6px_rgba(0,0,0,0.45)] md:p-10">
      <div className="mb-8 h-px bg-linear-to-r from-transparent via-primary/70 to-transparent" />
      <div className="mb-8 space-y-3 text-center">
        <span className="mx-auto flex size-12 items-center justify-center rounded-full bg-primary/15 text-[#EB0B1A]">
