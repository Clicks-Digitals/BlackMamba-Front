    ...
    <section className="relative left-1/2 w-screen max-w-[100vw] -translate-x-1/2 py-8 md:py-12">
      ...
      */}
      ...
      <div className="layout-page layout-gutter-x">
        <h2
          className={cn(
            "flex items-center gap-3 leading-none font-semibold uppercase text-foreground",
      ...
      <div className="relative left-1/2 mt-7 w-screen max-w-[100vw] -translate-x-1/2 md:mt-9">
        <div className="relative overflow-hidden border-y border-border bg-muted/60 py-6 md:py-8">
              ...
              {[0, 1].map((copy) => (
                ...
                >
                  {sponsors.map((sponsor, i) => {
                    ...
                    const img = (
                      <div className="group inline-flex h-18 min-w-28 shrink-0 items-center justify-center rounded-xl border border-border bg-[#EDEFF0] px-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/30 hover:shadow-[0_8px_20px_rgba(158,29,32,0.18)] md:h-20 md:min-w-32">
                        <Image
